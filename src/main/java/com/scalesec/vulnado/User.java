...
The `Statement` should be closed properly using try-with-resources.
...
To prevent SQL injection, use prepared statements instead of directly constructing SQL queries.
